...
macro(HIP_FIND_HELPER_FILE _name _extension)
    ...
    set(HIP_${_name} "${CMAKE_CURRENT_LIST_DIR}/${_hip_full_name}")
    if(NOT EXISTS "${HIP_${_name}}")
        set(error_message "${_hip_full_name} not found in ${CMAKE_CURRENT_LIST_DIR}")
        if(HIP_FIND_REQUIRED)
...
macro(HIP_PREPARE_TARGET_COMMANDS _target _format _generated_files _source_files)
    ...
    # Set compiler flags
    set(_HIP_HOST_FLAGS "set(CMAKE_HOST_FLAGS ${CMAKE_CXX_FLAGS})")
